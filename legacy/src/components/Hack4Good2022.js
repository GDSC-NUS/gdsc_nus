  ...
  },
  {
    ...
    content: (
      <p className="hack-workshops__body" style={{ textAlign: "center" }}>
        ...
        reserves, we take a long-term, disciplined approach to investing, and
        are uniquely positioned across a wide range of asset classes and active
        strategies globally. These include equities, fixed income, real estate,
        private equity, venture capital, and infrastructure. Our long-term
        approach, multi-asset capabilities, and global connectivity enable us to
        be an investor of choice. We seek to add meaningful value to our
        investments. Headquartered in Singapore, we have a global talent force
        of over 1,900 people in 11 key financial cities and have investments in
        over 40 countries.
      </p>
    ),
  },
